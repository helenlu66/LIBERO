...
class Libero10SubgoalDetector(Detector):
    '''
    ...
    def reached(self, obj:str) -> Union[bool, None]:
        '''
        Check if the gripper is reaching the obj.

        Args:
            obj (str): The name of the object

        Returns:
            bool: True if the gripper is reaching the object
        '''
        #TODO
    ...
    def at(self, obj:str, loc:str) -> Union[bool, None]:
        '''
        Check if the obj is at the loc.

        Args:
            obj (str): The name of the object
            loc (str): The name of the location

        Returns:
            bool: True if the object is at the location
        '''
        assert self._is_type(obj, 'pickupable-object')
        assert self._is_type(loc, 'container')
        return self.env._check_at(obj, loc)
